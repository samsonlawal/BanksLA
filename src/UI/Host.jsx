...
export default function Host() {
  return (
    <div className="bg-secondary flex flex-col justify-center items-center">
      <div
        id="location"
        className="bg-secondary px-4 py-20 gap-y-32 flex flex-col justify-center items-center md:items-start md:flex-row flex-wrap md:justify-evenly lg:px-4 font-mont max-w-[85%] 2xl:max-w-[70%]"
      >
        ...
        <div className="md:w-80 h-80 justify-center items-center flex flex-col">
          ...
          <p className="font-open">
            With over 8 years of experience in the property market and industry
            we are dedicated to exceptionalism in our designs, constructions,
